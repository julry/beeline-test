...
export const questions = {
    level1: [
        ...
        },
        {
            ...
            padding: [75, 20, 80, 20],
            svgSizes: {
                backgroundSvg: [353, 319],
                backgroundSvgBig: [354, 395],
            },
            marginTop: 22,
            backgroundSvg: (
                <svg width="100%" height="100%" viewBox="0 0 352 319" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.64375 66.6473C10.5183 27.5858 44.0326 -2.36412 83.0584 0.147126L281.248 12.9003C317.117 15.2085 345.409 44.308 346.707 80.2282L351.791 220.93C353.108 257.369 326.233 288.715 290.021 292.978L78.1866 317.917C35.2277 322.974 -1.99071 288.247 0.0827105 245.042L8.64375 66.6473Z" fill="white"/>
                </svg>
            ),
            backgroundSvgBig: (
            ...
            answers: [
                ...
                {
                    id: 'man-2',
                    text:'предложить помощь по вопросу коллеги',
                    padding: 'calc(var(--spacing_x3) * 1.2) 0 calc(var(--spacing_x3) * 1.5)',
                    left: '0.5px',
                    afterText: 'Ты делишься опытом. Коллега быстрее находит выход, команда экономит время. Новые подходы не ждут идеального момента',
                    svg: <Answer2Lines />
                },
            ],
            imageProps: {
    ...
    level2: [
        {
            ...
            answers: [
                ...
                },
                {
                    ...
                    afterText: 'Ты находишь причину сбоя. Связь возвращается, район снова оживает. Сеть страны держится на людях, а не на вышках',
                    svg: <Answer2Lines />
                },
            ],
            imageProps: {
            ...
            answers: [
                {
                    ...
                    afterText: 'Ты объясняешь ситуацию и не выходишь за пределы своей ответственности. Так устроена работа большой системы',
                    svg: <Answer2Lines isMirror/>
                },
                {
                    id: 'man-2',
    ...
    level3: [
            ...
            answers: [
                {
                    ...
                    afterTextStyle: `text-wrap: balance;`,
                    svg: <Answer2Lines isMirror />
                },
                {
                    id: 'sup-2',
        ...
        },
        {
            ...
            answers: [
                ...
                {
                    id: 'man-2',
                    text:'дать диспетчеру ориентиры по срокам восстановления',
